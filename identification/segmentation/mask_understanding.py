...
import torch 
from embed_projection import Projected
...
def test_feature_extraction(image_path, mask_path):
    ...
    print(len(attention_embeds))
    return attention_embeds


if __name__ == "__main__":
    test_feature_extraction("/data3/alex/gaussmart/identification/results/segments/segmented_images/image_000.png", "/data3/alex/gaussmart/identification/results/segments/masks/segments_000.npz")
